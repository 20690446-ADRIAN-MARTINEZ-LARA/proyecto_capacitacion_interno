<nav x-data="{ open: false }" style="background:rgb(27,57,107); border-bottom: 1px solid #535353">
                ...
                <div class="hidden sm:flex sm:items-center sm:ms-2">
                    <x-dropdown align="top" width="48">
                        ...
                        <x-slot name="content">
                            ...
                            <x-dropdown-link :href="route('solicitarcursos.index')">
                                {{ __('Mis solicitudes') }}
                            </x-dropdown-link>
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            <x-responsive-nav-link :href="route('solicitarcursos.create')" :active="request()->routeIs('dashboard')">
                {{ __('Solicitar curso') }}
            </x-responsive-nav-link>
            <x-responsive-nav-link :href="route('solicitarcursos.index')" :active="request()->routeIs('dashboard')">
                {{ __('Mis cursos solicitados') }}
            </x-responsive-nav-link>
            <x-responsive-nav-link :href="route('cursos.index')" :active="request()->routeIs('dashboard')">
                {{ __('Cursos') }}
            </x-responsive-nav-link>
        </div>
